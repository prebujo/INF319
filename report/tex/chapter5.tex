...
\Cref{fig:operators12} show that for smaller instances the heuristics H1-swap, H5-cluster aswell as H7-similar are getting higher weights before we find the optimal solution. This indicates that they are important for the smaller instances.
