...
\Cref{fig:heuristics} shows the weight of each heuristic through each segment of our model SCALNS segments for haphazardly selected runs. 
...
\Cref{fig:operators12} show that for smaller instances the heuristics H1, H4 aswell as H7 are getting higher weights before we find the optimal solution. This indicates that they are important for the smaller instances.
