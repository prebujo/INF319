...
\Cref{fig:operators} shows the weight of each operator through each segment of our model SCALNS segments for haphazardly selected runs. 
...
\Cref{fig:operators12} show that for smaller instances the heuristics C1, C4 aswell as C7 are getting higher weights before we find the optimal solution. This indicates that they are important for the smaller instances.
