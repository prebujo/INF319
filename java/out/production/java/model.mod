...
set N_vp_2{v in V};
set N_v_temp {v in V} = N_v_3[v] union V_p[v] union N_v_4[v] union V_d[v];
set N_vp_3{v in V} = setof{i in N_v_temp[v]:i>nn} i-nn;
set N_vp_4{v in V} = setof{i in N_v_temp[v]:i<=no} i;
set N_vp{v in V} = N_vp_2[v] inter N_vp_3[v] inter N_vp_4[v];
set N_v_3_2{v in V} = N_v_3[v] inter N_vp[v];
set N_v_4_2{v in V} = setof{i in N_vp[v]} i+nn;
set N_v{v in V} = N_v_3_2[v] union V_p[v] union N_v_4_2[v] union V_d[v];
